...
LRESULT CALLBACK WindowProcedure(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (message)                  /* handle the messages */
    {
        ...
        case WM_LBUTTONDOWN:
            ...
            //заполняем массив
            if (mas[masX][masY] == 0) mas[masX][masY] = 1;
            InvalidateRect(hwnd, NULL, TRUE);
        break;
        ...
        case WM_RBUTTONDOWN:
            ...
            masY = (int)(y / (clientHeight / n));
            //заполняем массив
            if (mas[masX][masY] == 0) mas[masX][masY] = 2;                  
            InvalidateRect(hwnd, NULL, TRUE);
        break;
...
int main(int argc, char** argv)
{
    ...
    vector<vector<int>> drop(n, vector<int>(n, 0));
    mas = drop;
    ...
    RegisterHotKey(hwnd, 2, MOD_SHIFT, 0x43); // SHIFT + C
